...
import { addProjectImg } from "@/app/actions/project";
import { toast } from "react-toastify";
import { useRouter } from "next/navigation";

interface ImagePickerProjectProps {
  projectId: string;
}
...
const ImagePickerProject: FC<ImagePickerProjectProps> = ({ projectId }) => {
  ...
  const handleAddImages = async () => {
    try {
      ...
      const res = await addProjectImg(projectId, selectedImages);
      router.refresh();
      setSelectedImages([]);
      console.log(res);
      if (res) {
...
export default ImagePickerProject;
