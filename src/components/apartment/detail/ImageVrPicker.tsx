"use client";
import { addAptImages, addVrImages } from "@/app/actions/apartment";
...
const ImageVrPicker: FC<props> = ({ apartmentId }) => {
  ...
  const handleAddImages = async () => {
    try {
      ...
      const res = await addVrImages(apartmentId, selectedImages);
      router.refresh();
      setSelectedImages([]);
      console.log(res);
      if (res) {
